                ...
                ElevatedButton.icon(
                  ...
                  icon: Icon(Icons.shopping_cart),
                    ...
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Color.fromRGBO(255, 255, 255, 1), backgroundColor: Colors.green,
...
void main() {
  runApp(MaterialApp(
    ...
    routes: {
      ...
      '/ShoppingCart': (context) => ShoppingCartScreen(), // Define your ShoppingCartScreen widget here
    },
  ));
}
